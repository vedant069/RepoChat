...
OLLAMA_URL = 'https://d7b9-34-34-73-76.ngrok-free.app/'
...
def generate_response(chat_id: str, conversation_history: str, query: str) -> str:
    ...
    try:
        ...
        # Only query chunks belonging to this chat
        ...
        messages = [
            {
                "role": "system",
                "content": f"You are a helpful AI assistant. Use the following context to answer the question, but don't mention that you're using any context: {context}"
            }
        ]
