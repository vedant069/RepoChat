...
OLLAMA_URL = 'https://2637-34-124-255-142.ngrok-free.app/'
                        ...
                        with open(file_path, "r", encoding="utf-8") as content_file:
                            ...
                            if chunks:
                                ...
                                for i, (chunk, embedding) in enumerate(zip(chunks, embeddings)):
                                    ...
                                    chunk_metadata['chunk_index'] = str(i)  # Convert to string
                                    
                                    collection.add(
                                        embeddings=[embedding.tolist()],  # Single embedding
                                        documents=[chunk],                # Single document
                                        metadatas=[chunk_metadata],      # Single metadata dict
